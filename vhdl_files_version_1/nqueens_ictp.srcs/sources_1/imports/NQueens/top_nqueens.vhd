...
--    p_din1: in std_logic_vector((N-1) downto 0);
--    p_fvali: in std_logic; 
...
architecture rtl of top_nqueens is 
    ...
    signal last_solu: std_logic_vector((N*(K_14+1)-1) downto 0); 
...
begin 
    ...
    last_digit <= unsigned(a_in_14((N*(M-1)-1) downto (N*(M-2)))); 
    ...
    GENERATE_FOR_out: for i in 0 to M-1 generate 
        asout_array(i) <= a_out_14((N*(i+1)-1) downto N*i); 
    end generate;         
    ...
    begin 
        if nRst = '1' then 
            ...
            done_s <= (emp1 and emp2 and emp3 and emp4 and emp5 and emp6 and emp7 and emp8 and emp9 and emp10 and emp11 and emp12 and emp13 and emp14); 
