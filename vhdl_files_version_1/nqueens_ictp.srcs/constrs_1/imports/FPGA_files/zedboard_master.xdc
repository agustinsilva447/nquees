...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN T22 [get_ports {count_0[0]}];  # "LD0"
#set_property PACKAGE_PIN T21 [get_ports {count_0[1]}];  # "LD1"
#set_property PACKAGE_PIN U22 [get_ports {count_0[2]}];  # "LD2"
#set_property PACKAGE_PIN U21 [get_ports {complete_tick_0}];  # "LD3"
#set_property PACKAGE_PIN V22 [get_ports {complete_tick_0}];  # "LD4"
#set_property PACKAGE_PIN W22 [get_ports {clock_led}];     # "LD5"
#set_property PACKAGE_PIN U19 [get_ports {reset_led}];     # "LD6"
#set_property PACKAGE_PIN U14 [get_ports {done_0}];        # "LD7"
...
## ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN F22 [get_ports {nRst_0}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {ce_0}];  # "SW1"
