...
port(
    ...
    counter : out std_logic_vector(P-1 downto 0);
    done    : out std_logic;
...
architecture rtl of top_nqueens is 
    ...
    signal last_solu: std_logic_vector((N*(K_17+1)-1) downto 0); 
...
begin 
    ...
    last_digit <= unsigned(a_in_17((N*(M-1)-1) downto (N*(M-2)))); 
    ...
    GENERATE_FOR_out: for i in 0 to M-1 generate 
        asout_array(i) <= a_out_17((N*(i+1)-1) downto N*i); 
    end generate;         
    ...
    begin 
        if nRst = '1' then 
            ...
            if (clk'event and clk = '1') then 
                if (ack_out_17 = '0' and s_nonzero = '0' and last_solu /= a_out_17) then 
                    last_solu <= a_out_17; 
    ...
    begin 
        if nRst = '1' then 
            ...
            done_s <= (emp1 and emp2 and emp3 and emp4 and emp5 and emp6 and emp7 and emp8 and emp9 and emp10 and emp11 and emp12 and emp13 and emp14 and emp15 and emp16 and emp17); 
